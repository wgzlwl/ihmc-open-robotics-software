...
import us.ihmc.humanoidRobotics.communication.controllerAPI.command.BodyOrientationTrajectoryCommand;
...
public class QuadrupedControllerAPIDefinition
{
   ...
   static
   {
      ...
      quadrupedCommands.add(BodyOrientationTrajectoryCommand.class);
