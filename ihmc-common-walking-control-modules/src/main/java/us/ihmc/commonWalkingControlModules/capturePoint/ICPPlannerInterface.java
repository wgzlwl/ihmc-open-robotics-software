...
public interface ICPPlannerInterface
{
   ...
   void setDesiredCapturePoint(FramePoint3DReadOnly desiredICPPosition);

   void setDesiredCapturePoint(FramePoint3DReadOnly desiredICPPosition, FrameTuple3DReadOnly desiredICPVelocity);

   void setDesiredCapturePoint(FramePoint3DReadOnly desiredICPPosition, FrameTuple3DReadOnly desiredICPVelocity, FrameTuple3DReadOnly desiredICPAcceleration);
